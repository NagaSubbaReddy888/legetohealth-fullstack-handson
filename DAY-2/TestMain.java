...
public class TestMain {
	...
	public static void main(String[] args) {
		...
		StudentDate stu1 = new StudentDate(1, "akul", "banglore", 65, 75, 61, 150, false);
		StudentDate stu2 = new StudentDate(1, "arun", "agra", 55, 75, 46, 190, true);
		StudentDate stu3 = new StudentDate(1, "banu", "uttar [radesh", 67, 90, 83, 100, false);

		System.out.println("Student who has the highest total marks");
		StudentDate date1 = highestMarkStudent(stu1, stu2, stu3);
		System.out.println(date1.getStudentName());

		System.out.println("Student who has the least Montly Fees");
		StudentDate date2 = leastMontlyFee(stu1, stu2, stu3);
		...
		studentEligibility(stu1);
		studentEligibility(stu2);
		studentEligibility(stu3);
